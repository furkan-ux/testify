...
var (
	pkg       = flag.String("assert-path", "github.com/furkan-ux/testify/assert", "Path to the assert package")
...
var headerTemplate = `// Code generated with github.com/furkan-ux/testify/_codegen; DO NOT EDIT.
